...
extern volatile bool UART_timeOutOccured;
...
extern void UART_handleTimeOut();

extern void initializeStimparams();
extern void initializeTimerSettings();
extern void enablePanel(uint8_t address);
